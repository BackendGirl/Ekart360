...
class HeaderNotificationsController extends Controller
{
    ...
    public function __construct()
    {
        ...
        try {
            ...
            $this->route = 'admin.header-notifications';
            $this->view = 'admin.header_notifications';
            $this->path = 'fees-fine';
            $this->access = 'fees-fine';
            $this->table_name = 'header_notifications';
            $this->theme = 'bakery';            
            $this->theme = $current_theme->slug;
            $this->theme_id = $current_theme->id;
            $this->storage_path = '/storage/photos/'.$this->theme.'/header_notifications/';                 
       } catch (\Throwable $th) {
          throw new Exception("505, Server Error");
         die;
       }
