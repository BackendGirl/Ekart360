...
class OffersController extends Controller
{
    ...
    public function __construct()
    {
        ...
        try {
            ...
            $this->storage_path = '/storage/photos/'.$this->theme.'/offers/';                 
       } catch (\Throwable $th) {
          throw new Exception("505, Server Error");
         die;
       }
    ...
    public function store(Request $request)
    {
        ...
        $uniqueUuid = Str::uuid(); // Generate a unique UUID
        $uniqueHexCode = bin2hex($uniqueUuid->getBytes()); // Convert UUID to hexadecimal
        $limitedHexCode = strtoupper(substr($uniqueHexCode, 0, 10));
