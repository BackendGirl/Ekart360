            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>{{ $title }}</h5>
                        <a href="{{route('admin.about.shapers_of_beds.create')}}" class="btn btn-primary btn-sm float-right"><i class="far fa-plus"></i> Add</a>
                    </div>
                                ...
                                <tbody>
                                  @foreach($profile as $key => $value)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin.about.shapers_of_beds.edit',$value->id)}}" class="btn btn-icon btn-primary btn-sm">
