        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <form method="post" action="{{route('admin.about.history.update')}}" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="row gx-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="editor" name="description" placeholder="Add description">{{$data->history}}</textarea>
                                    @error('description')
