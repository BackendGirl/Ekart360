    ...
    <div class="col-md-12">
        ...
        @method('PUT')
            ...
            <div class="form-group col-md-4">
                <label for="first_name">{{ __('field_first') }} {{ __('field_name') }}<span>*</span></label>
                <input type="text" class="form-control" name="first_name" id="first_name" value="{{ $row->first_name }}" required>

                <div class="invalid-feedback">
                  {{ __('required_field') }} {{ __('field_first') }} {{ __('field_name') }}
                </div>
            </div>

            <div class="form-group col-md-4">
                <label for="last_name">{{ __('field_last') }} {{ __('field_name') }} <span>*</span></label>
                <input type="text" class="form-control" name="last_name" id="last_name" value="{{ $row->last_name }}" required>

                <div class="invalid-feedback">
                  {{ __('required_field') }} {{ __('field_last') }} {{ __('field_name') }}
                </div>
            </div>
