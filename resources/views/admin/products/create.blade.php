                    ...
                    <div class="card-block">
                        <form method="post" action="{{route($route.'.store')}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control editor2" id="additional_info" name="additional_info" placeholder="Add additional_info">{{old('additional_info')}}</textarea>
                            </div>

                            <div class="form-group">
                                <label for="care_instruction">Care Instruction </label>
                                <textarea class="form-control editor3" id="care_instruction" name="care_instruction" placeholder="Add care_instruction">{{old('care_instruction')}}</textarea>
                            </div>
