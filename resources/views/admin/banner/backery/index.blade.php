                                ...
                                <tbody>
                                  @foreach($data as $key => $value)
                                    <tr>
                                        ...
                                        <td>
                                            @if($value->left_photo)
                                                <img src="{{URL::to($value->left_photo)}}" class="img-fluid zoom" style="max-width:80px" alt="{{$value->left_photo}}">
                                            @else
                                        ...
                                        <td>
                                            @if($value->right_photo)
                                                <img src="{{URL::to($value->right_photo)}}" class="img-fluid zoom" style="max-width:80px" alt="{{$value->right_photo}}">
                                            @else
                                                <img src="{{URL::to('public/backend/img/thumbnail-default.jpg')}}" class="img-fluid zoom" style="max-width:100px" alt="avatar.png">
                                            @endif
                                        </td>
