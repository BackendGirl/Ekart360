                          ...
                          <fieldset class="row scheduler-border">
                            ...
                            <div class="row gx-2">                                                          
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="main_title" class="form-control" value="{{ $data->center_title }}">
                                </div>
                                <div class="col-md-3">
                                    <label for="main_sub_title" class="col-form-label">Sub Title </label>
                                    <input type="text" name="main_sub_title" class="form-control" value="{{ $data->center_sub_title }}">
                                </div>
                                <div class="col-md-3">
                                    <label for="main_photo" class="col-form-label">{{ __('field_photo') }} <span class="text-danger">*</span></label>
                                    <input type="file" class="form-control" name="main_photo" id="main_photo" value="{{ $data->center_photo }}">
                                </div>     
                                <div class="col-md-3">
                          ...
                          <fieldset class="row scheduler-border">
                            ...
                            <div class="row gx-2">                                                          
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="side_title" class="form-control" value="{{ $data->right_title }}">
                                </div>
                                <div class="col-md-3">
                                    <label for="side_sub_title" class="col-form-label">Sub Title </label>
                                    <input type="text" name="side_sub_title" class="form-control" value="{{ $data->right_sub_title }}">
                                </div>
                                <div class="col-md-3">
                                    <label for="side_photo" class="col-form-label">{{ __('field_photo') }} <span class="text-danger">*</span></label>
                                    <input type="file" class="form-control" name="side_photo" id="side_photo" value="{{ $data->right_photo }}">
                                </div>  
                                <div class="col-md-3">
                                    <label for="" class="col-form-label">Old {{ __('field_photo') }}</label><br>
                                    @if($data->right_photo)
