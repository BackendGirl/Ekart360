            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>{{ $title }}</h5>
                        <a href="{{route('admin.gallery-category.create')}}" class="btn btn-primary btn-sm float-right"><i class="far fa-plus"></i> Add</a>
                    </div>
                                ...
                                <tbody>
                                  @foreach($gallery as $key => $value)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin.gallery-category.edit',$value->id)}}" class="btn btn-icon btn-primary btn-sm">
